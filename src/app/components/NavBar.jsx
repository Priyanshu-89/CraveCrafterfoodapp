  ...
  return (
    <div className="bg-[#0A090A] text-[#ea9a11] flex justify-between items-center px-8 py-2">
      ...
      <div className="flex space-x-4">
        <Link href="/">
          <p className="text-gold hover:text-white transition duration-300">Home</p>
        </Link>
        <Link href="/login">
          <p className="text-gold hover:text-white transition duration-300">Login</p>
        </Link>
        <Link href="/register">
          <p className="text-gold hover:text-white transition duration-300">Register</p>
        </Link>
      </div>
    </div>
  );
